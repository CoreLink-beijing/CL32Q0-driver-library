 ...
 * Change Logs:
 * Date           Author       Notes
 * 2019-02-14     corelink     the first version
 */
...
#define FUNC0_SPI0_CLK             	((uint32_t)0x0)     /* GPIO16 */
#define FUNC0_SPI0_CS0             	((uint32_t)0x0)     /* GPIO17 */
#define FUNC0_SPI0_MISO           	((uint32_t)0x0)     /* GPIO18 */
														/* GPIO19 */
...
#define FUNC0_SPI0_CS1             	((uint32_t)0x0)     /* GPIO24 */
#define FUNC0_SPI0_CS2             	((uint32_t)0x0)     /* GPIO25 */
#define FUNC0_SPI0_CS3             	((uint32_t)0x0)     /* GPIO26 */
														/* GPIO27 */
														/* GPIO28 */
														/* GPIO29 */
#define FUNC0_SPI0_MOSI            	((uint32_t)0x0)     /* GPIO30 */
 ...
 * gpio function 1
 */
#define FUNC1_SPI1_CLK             	((uint32_t)0x1)     /* GPIO0 */
#define FUNC1_SPI1_CS0             	((uint32_t)0x1)     /* GPIO1 */
#define FUNC1_SPI1_MISO            	((uint32_t)0x1)     /* GPIO2 */
														/* GPIO3 */
...
#define FUNC1_SPI1_CS1             	((uint32_t)0x1)     /* GPIO12 */
#define FUNC1_SPI1_CS2             	((uint32_t)0x1)     /* GPIO13 */
#define FUNC1_SPI1_CS3             	((uint32_t)0x1)     /* GPIO14 */
														/* GPIO15 */
                                                        /* GPIO16 */
                                                        /* GPIO17 */
                                                        /* GPIO18 */
...
#define FUNC1_SPI1_MOSI            	((uint32_t)0x1)     /* GPIO33 */
                                                        /* GPIO34 */
                                                        /* GPIO35 */
                                                        /* GPIO36 */                                                        
 ...
 * gpio function 4
 */
#define FUNC4_TEST                  ((uint32_t)0x4)     /* GPIO0 - GPIO36 */
...
#define GPIO_MODE_OUT_PULL_UP_WEAK  ((uint32_t)0x5)     /* 50kohm */
#define GPIO_MODE_OUT_PULL_UP       ((uint32_t)0x6)     /* 20kohm */
#define GPIO_MODE_AN       			((uint32_t)0x7)		/* analog */

/*
 * gpio direction
 */
#define GPIO_DIR_IN                 ((uint32_t)0x0)
#define GPIO_DIR_OUT                ((uint32_t)0x1)
...
#define GPIO_INT_RESET()          	do { ICP = GPIO_EVT; ECP = GPIO_EVT; } while(0)
