...
int i2cx_init(i2c_dev_t *i2c)
{
	...
	if (i2c == I2C0)
	{
		gpio_func_set(I2C0_SCL, FUNC0_I2C0_SCL);
		gpio_func_set(I2C0_SDA, FUNC0_I2C0_SDA);

		CGREG |= CG_I2C0;
	}
	else if (i2c == I2C1)
	{
		gpio_func_set(I2C1_SCL, FUNC0_I2C1_SCL);
		gpio_func_set(I2C1_SDA, FUNC0_I2C1_SDA);

		CGREG |= CG_I2C1;
	}
	else if (i2c == I2C2)
	{
		gpio_func_set(I2C2_SCL, FUNC0_I2C2_SCL);
		gpio_func_set(I2C2_SDA, FUNC0_I2C2_SDA);

		CGREG |= CG_I2C2;
	}
	else if (i2c == I2C3)
	{
		gpio_func_set(I2C3_SCL, FUNC1_I2C3_SCL);
		gpio_func_set(I2C3_SDA, FUNC1_I2C3_SDA);

		CGREG |= CG_I2C3;
	}
	else if (i2c == I2C4)
	{
		gpio_func_set(I2C4_SCL, FUNC1_I2C4_SCL);
		gpio_func_set(I2C4_SDA, FUNC1_I2C4_SDA);

		CGREG |= CG_I2C4;
	}
	else if (i2c == I2C5)
	{
		gpio_func_set(I2C5_SCL, FUNC1_I2C5_SCL);
		gpio_func_set(I2C5_SDA, FUNC1_I2C5_SDA);

		CGREG |= CG_I2C5;
	}

	/* workaround */
	R32_BITS_SET(0x1B005018, 0xc0000000, 0xc0000000);
...
int i2cx_deinit(i2c_dev_t *i2c)
{
	...
	/* workaround */
	R32_BITS_CLR(0x1B005018, 0xc0000000);
